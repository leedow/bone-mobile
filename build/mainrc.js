...
/***/ function(module, exports, __webpack_require__) {
	...
	var _counter = __webpack_require__(166);

	var _list = __webpack_require__(167);

	var _listItem = __webpack_require__(168);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Router = __webpack_require__(169).Router;
	var Route = __webpack_require__(169).Route;
	var Link = __webpack_require__(169).Link;
	var browserHistory = __webpack_require__(169).hashHistory;

	var PageTabs = _react2.default.createClass({
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ title: 'header title' },
						_react2.default.createElement(
							_headerDock.HeaderDock,
							{ align: 'left', title: '' },
							_react2.default.createElement(_icons.Icon, { type: 'back' })
						),
						_react2.default.createElement(_headerDock.HeaderDock, { align: 'right', title: 'Setting' })
					)
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_tab.Tab,
							{ type: '' },
							_react2.default.createElement(_tabItem.TabItem, null)
						)
					),
					_react2.default.createElement(
						_box.Box,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_tabItem.TabItem,
								{ href: 'test', name: 'Menu one', icon: 'true' },
								_react2.default.createElement(_icons.Icon, { type: 'settings' })
							),
							_react2.default.createElement(_tabItem.TabItem, { href: 'go', name: 'Menu two' })
						)
					)
				)
			);
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'bo-layout-header' },
					_react2.default.createElement(_header.Header, { title: 'Bone mobile' })
				),
				_react2.default.createElement(
					'div',
					{ className: 'bo-layout-main' },
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_tabItem.TabItem,
								{ href: '#tabs', name: 'Menu one', icon: 'true' },
								_react2.default.createElement(_icons.Icon, { type: 'settings' })
							),
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			Route,
			{ path: '/', component: App },
			_react2.default.createElement(Route, { path: '/home', component: PageHome }),
			_react2.default.createElement(Route, { path: '/tabs', component: PageTabs }),
			_react2.default.createElement(Route, { path: '*', component: NoMatch })
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tab = exports.Tab = _react2.default.createClass({
		displayName: 'Tab',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabItem = exports.TabItem = _react2.default.createClass({
		displayName: 'TabItem',
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'li',
				{ className: "bo-tab-item" + iconStyle + " bo-tab-item-arrow" },
				this.props.children,
				_react2.default.createElement(
					'a',
					{ className: 'bo-tl', href: this.props.href },
					this.props.name
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Box = exports.Box = _react2.default.createClass({
		displayName: 'Box',
		...
		render: function render() {
			return _react2.default.createElement(
				'section',
				{ className: "bo-box bo-m" + this.props.margin + " bo-p" + this.props.padding },
				this.props.children
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListItem = exports.ListItem = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecateObjectProperties = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibUseBasename = __webpack_require__(219);
