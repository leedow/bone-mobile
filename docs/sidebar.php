<aside class="bo-layout-sidebar">
	<div class="bo-sidebar">
		<h3 class="bo-sidebar-title">设 计</h3>
		<ul class="bo-tab-vertical">
			<li class="bo-tab-item"><a href="fonticon.php">字体图标</a>
		...
		<h3 class="bo-sidebar-title">基本布局</h3>
		<ul class="bo-tab-vertical">
			<li class="bo-tab-item"><a href="layouts.php">层和盒子</a>
				<div class="bo-tab-dock">
					Layouts&Box
				</div>
			</li>
